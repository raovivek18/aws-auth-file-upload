...
const fileService = {
    ...
    /**
     * Generates a temporary pre-signed URL for sharing
     */
    generateShareLink: async (file, currentUserId, expiresIn = 3600) => {
        // Security Check: Optional, depending on if you want to allow owners only to generate links
        // But pre-signed URLs are often generated by the owner to share with others.
        if (file.owner !== currentUserId) {
